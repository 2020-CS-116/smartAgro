          ...
          <View style={styles.allcardContainer}>
            ...
            <View style={styles.newCardRow}>
              ...
              <View style={styles.card_contain}>
                <View style={styles.img_cotainer}>
                  <TouchableOpacity onPress={() => navigation.navigate('disease-prediction')}>
                    <Image
                      source={require('../assets/h_img1.jpg')}
                      style={styles.card_img} />
                  </TouchableOpacity>
                </View>
                <Text style={styles.overlayText}> Disease Diagnoser </Text>
              </View>

              {/* Card 1 */}
              <View style={styles.card_contain}>
                <View style={styles.img_cotainer}>
                  <TouchableOpacity onPress={() => navigation.navigate('buyProducts')}>
                    <Image
                      source={require('../assets/h_img2.jpg')}
                      style={styles.card_img2} />
                  </TouchableOpacity>
                </View>
                <Text style={styles.overlayText}> Pestisides </Text>
              </View>
              ...
              {/* <View style={styles.cardContainer}>
                ...
                <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('disease-prediction')}>
                  <Text style={styles.buttonText}>Disease Diagnostic </Text>
                  {/* <AntDesign name='right' size={16} style={styles.icon} /> 
                </TouchableOpacity>
              </View> */}
