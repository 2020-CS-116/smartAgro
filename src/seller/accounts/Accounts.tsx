    ...
    <ScrollView>
      <View style={styles.container}>
       <View style={styles.profileContainer}>
        ...
        <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('sellerProfile')}>
      ...
      <View style={styles.rightContainer}>
        ...
        <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('sellerSupport')}>
        <View style={styles.leftContainer}>
        <View style={styles.logo}>
