  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('aboutSeller')}>
      ...
      <View style={styles.rightContainer}>
        ...
        <TouchableOpacity style={styles.button} onPress={()=>navigation.navigate('sellerTermsandConditions')}>
        <View style={styles.leftContainer}>
        <View style={styles.logo}>
